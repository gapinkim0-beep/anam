...
const I18N = {
  kr: {
    ...
    "nav.about": "소개",
    "nav.contact": "문의",
    "hero.eyebrow": "ANAM REAL ESTATE AGENCY",
    "hero.title": "라이프스타일을 중개합니다.",
    "hero.sub": "고려대·안암 일대, 당신의 라이프스타일에 꼭 맞는 집을 찾아드립니다.",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "hero.eyebrow": "ANAM REAL ESTATE AGENCY",
    "hero.title": "We mediate lifestyle.",
    "hero.sub": "Around Korea University & Anam — we find the home that fits your lifestyle.",
    "filter.type.label": "Property Type",
    "filter.type.all": "All",
    "filter.feature.label": "Features",
    "filter.submit": "Search",
    "list.heading": "Latest Listings",
